  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15.05 7.044a1.933 1.933 0 00-3.407-1.735L8.472 9.75H5.857l-.75.75V18l.75.75h10.964l2.304-4.607A3.554 3.554 0 0015.946 9h-1.548l.652-1.956zM9.608 10.74l3.256-4.559a.433.433 0 01.763.389l-1.31 3.93h3.63a2.054 2.054 0 011.836 2.972l-1.889 3.778H9.608v-6.51zm-1.5 6.51h-1.5v-6h1.5v6z"
        fill="#080341"
      />
    </svg>
  )
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12 4.5a7.5 7.5 0 00-4.772 13.286l.272.225V19.5H12a7.5 7.5 0 000-15zM3 12a9 9 0 119 9H6v-2.292A8.98 8.98 0 013 12z"
        fill="#080341"
      />
    </svg>
  )
...
export function BlueLikeIcon(props) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
