...
export default function SidebarMenu() {
    ...
    overflow-auto flex flex-col gap-2 min-w-[220px] max-xl:w-[200px]">
                ...
                <MenuItem icon={() => (<Avatar imgSrc="https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp" className="w-11 h-11 rounded-full"/>)} text="Andy codecamp" />
