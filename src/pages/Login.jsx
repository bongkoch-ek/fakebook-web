                        ...
                        <div className="card bg-base-100 w-full h-[350px] shadow-xl mt-8">
                            <form onSubmit={hdlLogin}>
                                <div className='card-body gap-3 p-4'>
                                    <input name='identity' value={input.identity} onChange={hdlChange} type='text' placeholder='E-mail or phone number' className='input input-bordered w-full' />
                                    <input name='password' value={input.password} onChange={hdlChange} type='text' placeholder='password' className='input input-bordered w-full' />
